...
GO
CREATE TABLE [a4b7a825f67930965747445709011120_kpi].[stock_transfer_order_line]
(
...
SET ANSI_PADDING ON
GO
ALTER TABLE [a4b7a825f67930965747445709011120_kpi].[stock_transfer_order_line] ADD  CONSTRAINT [Cnstr_77b36c29c14d499099746feead70bbd0] PRIMARY KEY NONCLUSTERED 
(
	[id] ASC
) NOT ENFORCED 
GO
