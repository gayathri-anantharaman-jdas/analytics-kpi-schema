...
GO
CREATE TABLE [a4b7a825f67930965747445709011120_kpi].[purchase_order_schedule]
(
...
SET ANSI_PADDING ON
GO
ALTER TABLE [a4b7a825f67930965747445709011120_kpi].[purchase_order_schedule] ADD  CONSTRAINT [Cnstr_0da51926c88b477f9821f7d0540f2e31] PRIMARY KEY NONCLUSTERED 
(
	[id] ASC
) NOT ENFORCED 
GO
